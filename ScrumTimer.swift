 ...
 */
//taken from starting file of iOS documentation
...
class ScrumTimer: ObservableObject {
    ...
    private var frequency: TimeInterval { 1 }
    ...
    //time fire every frquency timeinterval which execute the block of code which update the data member  
